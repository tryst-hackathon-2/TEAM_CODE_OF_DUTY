...
export function signIn(username, password) {
  return request("https://jagrookapi.herokuapp.com/auth/token/login/", {
...
export function register(username, password) {
  return request("https://jagrookapi.herokuapp.com/auth/users/", {
    data: { username, password },
    method: "POST",
  });
}
...
export function fetchPlaces(token) {
  return request("https://jagrookapi.herokuapp.com/api/places/", { token });
}

export function addPlace(data, token) {
  console.log(data);
  return request("https://jagrookapi.herokuapp.com/api/places/", {
    data,
    token,
    method: "POST",
  });
...
export function fetchPlace(id, token) {
  return request(`https://jagrookapi.herokuapp.com/api/places/${id}`, {
    token,
  });
}

export function addCategory(data, token) {
  return request("https://jagrookapi.herokuapp.com/api/categories/", {
    data,
    token,
    method: "POST",
  });
...
export function addMenuItems(data, token) {
  return request("https://jagrookapi.herokuapp.com/api/menu_items/", {
    data,
    token,
    method: "POST",
  });
...
export function updateMenuItem(id, data, token) {
  return request(`https://jagrookapi.herokuapp.com/api/menu_items/${id}`, {
    data,
    token,
    method: "PATCH",
  });
...
export function removeCategory(id, token) {
  return request(`https://jagrookapi.herokuapp.com/api/categories/${id}`, {
    token,
    method: "DELETE",
  });
}
...
export function createPaymentIntent(data, token) {
  return request(
    "https://jagrookapi.herokuapp.com/api/create_payment_intent/",
    {
      data,
      token,
      method: "POST",
...
export function fetchOrders(placeId, token) {
  return request(
    `https://jagrookapi.herokuapp.com/api/orders/?place=${placeId}`,
    { token }
  );
}

export function completeOrder(id, data, token) {
  return request(`https://jagrookapi.herokuapp.com/api/orders/${id}`, {
    data,
    token,
    method: "PATCH",
  });
